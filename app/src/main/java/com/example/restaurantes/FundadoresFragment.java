...
public class FundadoresFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            view = inflater.inflate(R.layout.fragment_fundadores, container, false);
            ...
            // Maneja cualquier excepción que ocurra durante la configuración del fragmento
            System.err.println("Error configurando el fragmento Fundadores: " + e.getMessage());
        }
